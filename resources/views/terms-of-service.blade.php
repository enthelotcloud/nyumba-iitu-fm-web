...
<div class="min-h-screen py-10 px-5 text-slate-200" style="background: linear-gradient(135deg, #0a0a1a 0%, #1a1a2e 100%);">
    <div class="max-w-7xl mx-auto">
        <div>
            ...
            <div class="space-y-8">
                <section>
                    <h2 class="text-2xl font-semibold text-blue-400 mb-4">1. Use of the Service</h2>
                    <p class="mb-2 text-slate-300">We grant you a personal, non-exclusive, non-transferable, and revocable license to use our Service for personal, non-commercial purposes. You agree not to:</p>
                ...
                <section>
                    <h2 class="text-2xl font-semibold text-blue-400 mb-4">2. Intellectual Property Rights</h2>
                    <p class="mb-2 text-slate-300">All content provided through the Service is protected by intellectual property laws.</p>
                    <ul class="list-disc pl-8 space-y-2 text-slate-300">
                ...
                <section>
                    <h2 class="text-2xl font-semibold text-blue-400 mb-4">3. User-Generated Content</h2>
                    <p class="mb-4 text-slate-300">If you submit requests, feedback, or messages to us (e.g., via WhatsApp or SMS), you grant Nyumba iitu FM the right to read or broadcast these submissions on air, unless you explicitly request otherwise. We reserve the right to review and remove any user-submitted content at our discretion.</p>
                </section>

                <section>
                    <h2 class="text-2xl font-semibold text-blue-400 mb-4">4. Third-Party Links and Services</h2>
                    <p class="mb-4 text-slate-300">Our Service may contain links to third-party websites or services that are not owned or controlled by Nyumba iitu FM. We have no control over, and assume no responsibility for, the content, privacy policies, or practices of any third-party websites. We strongly advise you to read the terms and conditions and privacy policies of any third-party sites you visit.</p>
                </section>

                <section>
                    <h2 class="text-2xl font-semibold text-blue-400 mb-4">5. Disclaimer of Warranties</h2>
                    <p class="mb-4 text-slate-300">The Service is provided on an "AS IS" and "AS AVAILABLE" basis. Nyumba iitu FM makes no representations or warranties of any kind, express or implied, regarding the operation of the Service or the information, content, or materials included. We do not warrant that the audio stream will be uninterrupted, secure, or free of errors.</p>
                </section>

                <section>
                    <h2 class="text-2xl font-semibold text-blue-400 mb-4">6. Limitation of Liability</h2>
                    <p class="mb-4 text-slate-300">In no event shall Nyumba iitu FM, its directors, employees, or partners be liable for any indirect, incidental, special, consequential, or punitive damages arising out of your access to or use of, or inability to access or use, the Service.</p>
                </section>

                <section>
                    <h2 class="text-2xl font-semibold text-blue-400 mb-4">7. Changes to Terms</h2>
                    <p class="mb-4 text-slate-300">We reserve the right to modify or replace these Terms at any time. We will provide notice of any significant changes by posting the new Terms on this page and updating the "Effective Date" at the top. Your continued use of the Service after any such changes constitutes your acceptance of the new Terms.</p>
                </section>
            </div>

            <div class="mt-10 p-8 bg-blue-500/5 rounded-xl border border-blue-500/10 text-center">
                <h2 class="text-xl font-bold text-slate-200 mb-4">Questions about these Terms?</h2>
